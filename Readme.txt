...
-----------------------------------------
 ...
 - File may appear in source directory and transfer when pasting images from clipboard
...
------------------------------------------
 ...
 - Windshear run time estimate for run estimations

 - Direct camera copy script.  Copies all files from camera with a single click.
